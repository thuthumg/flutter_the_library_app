                ...
                child: Container(
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      BookVO? bookVO = eachCategoryBookVOList?[index]
                          .bookDetails?[0]
                          .convertBookVO(null, listId, categoryName);
                                                  ...
                                                  builder:
                                                    ...
                                                    return BottomSheetView(
                                                      ...
                                                      onTapDeleteBookFromYourLibrary: (){
                                                        if(bookVO != null)
                                                          {
                                                            CategoryDetailBloc bloc = Provider.of<CategoryDetailBloc>(context, listen: false);
